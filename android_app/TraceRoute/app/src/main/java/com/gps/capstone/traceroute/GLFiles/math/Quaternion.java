package com.gps.capstone.traceroute.GLFiles.math;

import android.util.FloatMath;

/**
 * Defines a quaternion. Stolen from the open source project here:
 * https://github.com/TraxNet/ShadingZen/tree/master/library/src/main/java/org/traxnet/shadingzen/math
 */
...
public class Quaternion {
    ...
    /** Sets this quaternion as the angle rotation around the axis defined
     * by x, y, and z. */
